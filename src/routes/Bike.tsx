...
const Bike: FC = () => {
    ...
    if (data) {
        return (
            <main className='screen-height flex items-center'>
                <AnimatePresence >
                    <motion.div
                        ...
                        <a className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
                            ...
                            <span className="absolute top-0 left-0 m-2 rounded-full bg-black px-2 text-center text-sm font-medium text-white">{data.discount}% OFF</span>
                        </a>
                        <div className="mt-4 px-5 pb-5">
                            <a href="#">
                                <h5 className="text-xl tracking-tight font-medium text-black">{data.name}</h5>
                            </a>
